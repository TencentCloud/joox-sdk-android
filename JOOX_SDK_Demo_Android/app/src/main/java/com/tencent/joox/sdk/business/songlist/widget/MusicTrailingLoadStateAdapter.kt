...
class MusicTrailingLoadStateAdapter(isLoadEndDisplay: Boolean = true): TrailingLoadStateAdapter<MusicTrailingLoadStateAdapter.TrailingLoadStateVH>(isLoadEndDisplay) {
    ...
    class TrailingLoadStateVH(
        parent: ViewGroup,
        view: View = LayoutInflater.from(parent.context).inflate(R.layout.music_trailing_load_more, parent, false)
