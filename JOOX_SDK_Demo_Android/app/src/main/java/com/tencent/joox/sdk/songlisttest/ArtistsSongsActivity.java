...
public class ArtistsSongsActivity extends AppCompatActivity implements AppPlayManager.PlayerListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String path = String.format("v1/artist/%s/tracks?", id);
        ...
        SDKInstance.getmInstance().doJooxRequest(path, paramString, new SceneBase.OnSceneBack() {
            ...
            public void onFail(int errCode) {
                Toast.makeText(ArtistsSongsActivity.this, "歌手歌曲请求失败， 错误码："+ errCode, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onError(int code) {
        Toast.makeText(this, "播放错误，错误码：" + code, Toast.LENGTH_SHORT).show();
    }
