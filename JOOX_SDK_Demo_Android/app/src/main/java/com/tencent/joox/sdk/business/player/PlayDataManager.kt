...
//        SDKInstance.getIns().doJooxRequest("third_tag?",requestParamBuilder.setCommonParam().setCountryParam().setLanguageParam().getResultString(),object: SceneBase.OnSceneBack{
...
//        SDKInstance.getIns().doJooxRequest("v1/tag/" + tagId + "playlists?", playlistParamBuilder.setCountryParam().setLanguageParam().setNumParam().setIndexParam(0).getResultString(), object : SceneBase.OnSceneBack {
//            override fun onSuccess(responseCode: Int, JsonResult: String?) {
//                TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
//                val parser = JSONParser(JsonResult)
//                val errorCode = parser.getString("error_code")
...
//        SDKInstance.getIns().doJooxRequest("v1/playlist/"+albumId+"/tracks?",albumlistParamBuilder.setCountryParam().setLanguageParam().setNumParam().setIndexParam(0).getResultString(),object:SceneBase.OnSceneBack{
//            override fun onSuccess(responseCode: Int, JsonResult: String?) {
...
//        SDKInstance.getIns().doJooxRequest("v1/track/"+songOpenId+"?",trackParamBuilder.setLanguageParam().setCountryParam().getResultString(),object:SceneBase.OnSceneBack{
//            override fun onSuccess(responseCode: Int, JsonResult: String?) {
//                TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
