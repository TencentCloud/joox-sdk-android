...
import com.tencent.joox.sdk.business.search.model.SearchAllModel
import com.tencent.joox.sdk.business.search.widget.SearchAllSectionAdapter
...
class SearchAllFragment : Fragment(), TrailingLoadStateAdapter.OnTrailingListener {

    private lateinit var binding: SearchTabLayoutBinding
    private val sectionAdapter by lazy { SearchAllSectionAdapter(arrayListOf()) }
    private val model: SearchAllModel by lazy {
        ViewModelProvider.NewInstanceFactory().create(SearchAllModel::class.java)
    }
